...
const I18n = {
  en: {
    answerBlockText: "[TEXT] Answer",
    answerBlockDefaultValue: "How can I get better at Scratch?",
    answerFuncEnterOpenAIApiKey:
      "Enter the API key obtained from the openai.com site",
    clearMessageLogsBlockText: "Clear message logs",
    setMaxTokensBlockText: "Set max tokens [NUMBER]",
    setApiKeyBlockText: "Set API key",
    setTemperatureBlockText: "Set temperature (0-2) [NUMBER]",
    setTimeoutBlockText: "Set timeout [NUMBER]",
    setApiKeyBlockDefaultValue: "API key",
    setApiKeyFuncAzurePromptText: "No API key required",
  ...
  ja: {
    ...
    answerBlockDefaultValue: "Scratch が上手くなるには?",
    answerFuncEnterOpenAIApiKey:
      "openai.com のサイトからAPIキーを取得してセットください",
    clearMessageLogsBlockText: "メッセージログをクリア",
    setMaxTokensBlockText: "最大トークン数を設定[NUMBER]",
    setTemperatureBlockText: "temperature を設定 (0-2) [NUMBER]",
    setTimeoutBlockText: "timeout を設定 [NUMBER]",
    setApiKeyBlockText: "APIキーをセット",
    setApiKeyBlockDefaultValue: "API キー",
    setApiKeyFuncAzurePromptText: "APIキーは不要です",
    setApiKeyFuncPromptText: "APIキーを入力してください",
    setSystemPromptBlockText: "システムプロンプトを設定 [TEXT]",
    answerFuncFailedToGetAnswer: "答えを取得できませんでした",
  },
  "ja-Hira": {
    answerBlockText: "[TEXT]のこたえ",
    answerBlockDefaultValue: "スクラッチがうまくなるには?",
    answerFuncEnterOpenAIApiKey:
      "オープンエーアイエーアイキーをにゅうりょくしてください",
    clearMessageLogsBlockText: "メッセージログをクリア",
    setMaxTokensBlockText: "さいだいトークンすうをせってい[NUMBER]",
    setTemperatureBlockText: "テンパラチュアをせってい (0-2) [NUMBER]",
    setTimeoutBlockText: "タイムアウトをせってい [NUMBER]",
    setApiKeyBlockText: "エーピーアイキーをセット",
    setApiKeyBlockDefaultValue: "エーピーアイキー",
    setApiKeyFuncAzurePromptText: "APIキーはふようです",
    setApiKeyFuncPromptText: "エーピーアイキーをにゅうりょくしてください",
    setSystemPromptBlockText: "システムプロンプトをせってい [TEXT]",
...
const comesFromCoderDojoJapan = (() => {
  ...
  const allowedOrigins = ["https://coderdojo.jp", "https://coderdojo-seto.jp"];
...
class Scratch3ChatGPTBlocks {
  ...
  constructor(runtime) {
    ...
    this.apiKey =
      window.sessionStorage.getItem(this.SESSION_STORAGE_KEY_CHATGPT_API_KEY) ||
      "";
    this.maxTokens = 300;
    this.temperature = 1;
    this.timeout = 30000;
  ...
  setApiKey() {
    if (comesFromCoderDojoJapan) {
      ...
      window.sessionStorage.setItem(
        this.SESSION_STORAGE_KEY_CHATGPT_API_KEY,
        this.apiKey,
      );
    }
  }
